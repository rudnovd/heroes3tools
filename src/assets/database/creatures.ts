...
export const creatures: Array<Creature> = [
  ...
  },
  {
    ...
    description: 'Generates 1 Gold per unit per day',
  },
  {
    name: 'Kobold Foreman',
    nativeTerrain: Terrains.Snow,
  ...
  },
  {
    ...
    description: 'Immune to Ice Bolt and Frost Ring, Adjacent enemies receive +20% Spell Damage',
  },
  {
    name: 'Snow Elf',
    nativeTerrain: Terrains.Snow,
  ...
  },
  {
    ...
    description: 'Ranged (8 shots), No melee penalty, May shoot while adjacent to enemy creatures',
  },
  {
    name: 'Yeti',
    nativeTerrain: Terrains.Snow,
    ...
    description: 'Recovers from negative effects in one round of combat',
  },
  {
    name: 'Yeti Runemaster',
    nativeTerrain: Terrains.Snow,
    id: 186,
    townId: Towns.Bulwark,
    attack: 11,
    ...
    description: 'Recovers from negative effects in one round of combat, Possesses Runes',
  },
  {
    name: 'Shaman',
    nativeTerrain: Terrains.Snow,
    ...
    description: 'Ranged (12 shots), Spellcaster (Air Shield)',
  },
  {
    name: 'Great Shaman',
    nativeTerrain: Terrains.Snow,
    ...
    description: 'Ranged (24 shots), Spellcaster (Air Shield), Freezing Shot',
  },
  {
    name: 'Mammoth',
    nativeTerrain: Terrains.Snow,
  ...
  },
  {
    ...
    description: 'Receives +100% Defense while defending in combat',
  },
  {
    name: 'Jotunn',
    nativeTerrain: Terrains.Snow,
    ...
    description: 'Teleports allies (once per combat), -1 enemy flying units\' Speed',
  },
  {
    name: 'Jotunn Warlord',
    nativeTerrain: Terrains.Snow,
    ...
    description: 'Teleports allies (unlimited), -2 enemy flying units\' Speed',
  },
]
