...
describe('hero specialty spell modificator', () => {
  ...
  describe('bloodlust spell specialty', () => {
    it('ash with Imp (creature level - 1)', () => {
      ...
      const creatureWithModifiedAttack = Modificators.heroPositiveSpecialtySpell(
  ...
  describe('prayer spell specialty', () => {
    it('loynis with Troglodyte (creature level - 1)', () => {
      ...
      const creatureWithModifiedStats = Modificators.heroPositiveSpecialtySpell(
        battle.attacker.hero,
        battle.attacker.activeCreature,
      )
  ...
  describe('stone Skin spell specialty', () => {
    it('darkstorn with Pikeman (creature level - 1)', () => {
      ...
      const creatureWithModifiedDefense = Modificators.heroPositiveSpecialtySpell(
        battle.attacker.hero,
        battle.attacker.activeCreature,
      )
  ...
  describe('weakness spell specialty', () => {
    it('mirlanda with Gremlin (creature level - 1)', () => {
      ...
      battle.defender.activeCreature = getCreatureInstance(Creatures.Gremlin)
      const creatureWithModifiedAttack = Modificators.heroPositiveSpecialtySpell(
        battle.attacker.hero,
        battle.defender.activeCreature,
      )
      const { attack } = Effects.weakness(battle.attacker, creatureWithModifiedAttack)
      expect(attack).toBe(0)
    })

    it('mirlanda with Red Dragon (creature level - 7)', () => {
      battle.attacker.hero = getHeroInstance(Heroes.Mirlanda)
      battle.defender.activeCreature = getCreatureInstance(Creatures.RedDragon)
      const creatureWithModifiedAttack = Modificators.heroNegativeSpecialtySpell(
        battle.attacker.hero,
        battle.defender.activeCreature,
      )
      const { attack } = Effects.weakness(battle.attacker, creatureWithModifiedAttack)
    ...
    it('mirlanda with Master Genie (creature level - 5)', () => {
      battle.attacker.hero = getHeroInstance(Heroes.Mirlanda)
      battle.defender.activeCreature = getCreatureInstance(Creatures.MasterGenie)
      const creatureWithModifiedAttack = Modificators.heroNegativeSpecialtySpell(
        battle.attacker.hero,
        battle.defender.activeCreature,
      )
    ...
    it('mirlanda with Master Black Dragon (creature level - 7)', () => {
      battle.attacker.hero = getHeroInstance(Heroes.Mirlanda)
      battle.defender.activeCreature = getCreatureInstance(Creatures.BlackDragon)
      const creatureWithModifiedAttack = Modificators.heroNegativeSpecialtySpell(
        battle.attacker.hero,
        battle.defender.activeCreature,
      )
  ...
  describe('disrupting Ray spell specialty', () => {
    it('aenain with Skeleton (creature level - 1)', () => {
      ...
      const creatureWithModifiedDefense = Modificators.heroNegativeSpecialtySpell(
        battle.attacker.hero,
        battle.defender.activeCreature,
      )
    ...
    it('aenain with Wraith (creature level - 3)', () => {
      battle.attacker.hero = getHeroInstance(Heroes.Aenain)
      battle.defender.activeCreature = getCreatureInstance(Creatures.Wraith)
      const creatureWithModifiedDefense = Modificators.heroNegativeSpecialtySpell(
        battle.attacker.hero,
        battle.defender.activeCreature,
      )
    ...
    it('aenain with Power Lich (creature level - 5)', () => {
      battle.attacker.hero = getHeroInstance(Heroes.Aenain)
      battle.defender.activeCreature = getCreatureInstance(Creatures.PowerLich)
      const creatureWithModifiedDefense = Modificators.heroNegativeSpecialtySpell(
        battle.attacker.hero,
        battle.defender.activeCreature,
      )
    ...
    it('aenain with Ghost Dragon (creature level - 7)', () => {
      battle.attacker.hero = getHeroInstance(Heroes.Aenain)
      battle.defender.activeCreature = getCreatureInstance(Creatures.GhostDragon)
      const creatureWithModifiedDefense = Modificators.heroNegativeSpecialtySpell(
        battle.attacker.hero,
        battle.defender.activeCreature,
      )
